...
public class LockPatternUtil {
    ...
    public static boolean checkPattern(List<LockPatternView.Cell> pattern, String password) {
        if (pattern == null || password == null) {
            return false;
        } else {
            String password2 = patternToString(pattern);
