package com.hyf.tdlibrary.widget;
...
import com.hyf.tdlibrary.utils.DisplayUtil;
...
public class SafeKeyboardView extends LinearLayout {
    ...
    private void initView() {
        ...
        setPadding(DisplayUtil.dp2px(20), DisplayUtil.dp2px(15), DisplayUtil.dp2px(20), DisplayUtil.dp2px( 10));
        addHeader();
        addGridPasswdView();
    ...
    private void addGridPasswdView() {
        ...
        gridView.setHorizontalSpacing(DisplayUtil.dp2px(10));
        gridView.setVerticalSpacing(DisplayUtil.dp2px(10));
        addView(gridView);
